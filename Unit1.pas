...
begin
  ...
  begin
    ...
    //Controllo che le stringhe non siano finite
    //(Count si usa per le liste, lenght per gli array)
    ...
    begin
      ...
      begin
        ...
        begin
          //uso .Chars perchè in delphi di M string[] va da 1 ad n
          //mentre string.chars[] va da 0 ad n-1

          //trovo l'indice della prima occorrenza dell'apice (+1 perchè l'apice
          //poi non mi serve
          ...
          // Lstart (compreso) ad LEnd-LStart (lunghezza)
        ...
        begin
          ...
          //un nuovo assegnamento del tipo * = * (count mi da il num di elementi)
          while(LRowIndex < LStrings.Count) and not IsOk(LStrings[LRowIndex]) do
          begin
          ...
          //sono già andata avanti prima e torno indietro
          LRowIndex := LRowIndex - 1;
          mmo1.Lines.Add(LLongCaption);
        end;
      end;
      //incremento per analizzare prossima riga della TStringList
      LRowIndex:= LRowIndex + 1;
    end;
  end;
end;
